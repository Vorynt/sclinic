...
|----|-------|--------|------|---------|
| **E1** | Plataforma, identidade e multi-clínica | Done | — | authentication, clinics, users |
| **E2** | Monetização SaaS (Stripe) | Done | 003, 004 | billing |
| **E3** | Cadastro clínico (pacientes & profissionais) | Done | — | patients, professionals |
...
### E1 — Plataforma
Auth (login, signup, verify, reset, change-password), convites equipe/profissional, select-clinic, membership suspended, onboarding plan→clinic→hours.

### E2 — SaaS
Planos, Checkout, Customer Portal, webhook, entitlement gate, over_limit banner + assertPlanCapacity.

### E3 — Cadastros
CRUD pacientes (CPF único/clínica), convite e perfil de profissionais com quota.
