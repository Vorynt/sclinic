...
ALTER TABLE IF EXISTS clinic_services FORCE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS clinics FORCE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS clinic_business_hours FORCE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS clinic_calendar_settings FORCE ROW LEVEL SECURITY;
