...
function getEyeDropper(): EyeDropperApi | null {
  ...
  const Ctor = (window as Window & { EyeDropper?: new () => EyeDropperApi })
    .EyeDropper;
...
function ColorBand({
  ...
  return (
    <SliderPrimitive.Root
      ...
      <SliderPrimitive.Thumb className="block size-3.5 shrink-0 rounded-full border border-black/10 bg-white shadow-sm ring-0 transition-shadow select-none hover:ring-3 hover:ring-ring/40 focus-visible:ring-3 focus-visible:ring-ring/50 focus-visible:outline-hidden disabled:pointer-events-none" />
    </SliderPrimitive.Root>
  );
}
