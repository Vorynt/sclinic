...
import { createExamRequestSchema } from "@/modules/medical-records/schemas/prescription.schema"
...
export async function createExamRequestAction(
  ...
  return toActionResult(async () => {
    const parsed = parseOrThrow(createExamRequestSchema, data)
    return prescriptionService.createExamRequest(
      parsed,
