...
export function DeleteClinicDangerZone({ clinic }: DeleteClinicDangerZoneProps) {
        ...
        <AlertDialogContent>
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="delete-clinic-confirmation">
              Nome da clínica: <span className="font-medium">{clinic.name}</span>
            </Label>
            <Input
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              onClick={(event) => {
                ...
                setFormError(null)
                deleteClinic.mutate({ confirmationName: confirmationName.trim() })
              }}
            >
