...
export function LandingShowcase() {
  ...
  const [agenda, attendance, patients] = showcase.sections
...
function ShowcaseBlock({
  ...
  return (
    <div
      className={
        reverse
          ? "grid items-center gap-8 lg:grid-cols-[1.15fr_minmax(0,0.85fr)] lg:gap-12"
          : "grid items-center gap-8 lg:grid-cols-[minmax(0,0.85fr)_1.15fr] lg:gap-12"
      }>
