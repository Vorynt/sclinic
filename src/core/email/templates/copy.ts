...
export const emailTemplateCopy = {
  ...
  collaboratorInvite: {
    ...
    body: [
      ...
      "",
      "Com o acesso, você poderá usar as ferramentas da clínica de acordo com as permissões do seu perfil.",
      "",
  ...
  professionalInvite: {
    ...
    previewText:
      "Revise seus dados e confirme o convite para atuar como profissional.",
    body: [
      "Olá, {{{USER_NAME}}},",
      "",
      "{{{INVITER_NAME}}} convidou você para atuar como profissional em {{{CLINIC_NAME}}} no sclinic (perfil: {{{ROLE_NAME}}}).",
      "",
      "Antes de aceitar, você poderá revisar e confirmar seus dados profissionais na plataforma.",
      "",
